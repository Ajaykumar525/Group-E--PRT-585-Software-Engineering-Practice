...
namespace LOGIC.Services.Interfaces
{
    public interface ICustomer_Service
    {
        ...
        Task<Generic_ResultSet<Customer_ResultSet>> AddCustomer(string name, string Customer_Lastname, string Contact_Number);
        Task<Generic_ResultSet<Customer_ResultSet>> UpdateCustomer(Int64 id, string name, string Customer_Lastname, string Contact_Number);
