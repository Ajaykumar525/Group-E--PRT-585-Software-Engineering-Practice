...
namespace LOGIC.Services.Interfaces
{
    public interface IMovie_Service
    {
        ...
        Task<Generic_ResultSet<Movie_ResultSet>> AddMovie(string name, string director, string language, string price);
        Task<Generic_ResultSet<Movie_ResultSet>> UpdateMovie(Int64 id, string name, string director, string language, string price);
