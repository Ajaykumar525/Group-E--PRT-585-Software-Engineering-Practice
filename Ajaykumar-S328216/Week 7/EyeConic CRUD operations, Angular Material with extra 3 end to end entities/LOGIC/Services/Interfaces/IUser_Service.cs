...
namespace LOGIC.Services.Interfaces
{
    public interface IUser_Service
    {
        ...
        Task<Generic_ResultSet<User_ResultSet>> AddUser(string name, Int64 contact, string email, string address);
        Task<Generic_ResultSet<User_ResultSet>> UpdateUser(Int64 id, string name, Int64 contact, string email, string address);
