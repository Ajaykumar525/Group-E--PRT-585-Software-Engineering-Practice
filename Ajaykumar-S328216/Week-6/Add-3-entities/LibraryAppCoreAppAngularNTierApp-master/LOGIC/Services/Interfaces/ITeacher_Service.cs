...
namespace LOGIC.Services.Interfaces
{
    public interface ITeacher_Service
    {
        ...
        Task<Generic_ResultSet<Teacher_ResultSet>> AddTeacher(string name, Int32 experience);
        Task<Generic_ResultSet<Teacher_ResultSet>> UpdateTeacher(Int64 id, string name, Int32 experience);
