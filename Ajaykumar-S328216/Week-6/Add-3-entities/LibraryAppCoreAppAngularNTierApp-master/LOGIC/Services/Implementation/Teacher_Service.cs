...
namespace LOGIC.Services.Implementation
{
    ...
    public class Teacher_Service : ITeacher_Service
    {
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Teacher_ResultSet>> AddTeacher(string name, Int32 experience)
        {
            Generic_ResultSet<Teacher_ResultSet> result = new Generic_ResultSet<Teacher_ResultSet>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Teacher_ResultSet>> UpdateTeacher(Int64 Teacher_id, string name, Int32 experience)
        {
            Generic_ResultSet<Teacher_ResultSet> result = new Generic_ResultSet<Teacher_ResultSet>();
            try
            {
