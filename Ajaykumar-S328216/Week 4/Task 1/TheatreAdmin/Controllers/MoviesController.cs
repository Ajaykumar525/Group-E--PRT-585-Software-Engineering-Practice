...
namespace TheatreAdmin.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Director,Email,Language,Price,Category")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ReleaseDate,Director,Email,Language,Price,Category")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
