...
namespace LOGIC.Services.Implementation
{
    ...
    public class Movie_Service : IMovie_Service
    {
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Movie_ResultSet>> AddMovie(String name, String director, String genre, String language, decimal price)
        {
            Generic_ResultSet<Movie_ResultSet> result = new Generic_ResultSet<Movie_ResultSet>();
            try
            {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public async Task<Generic_ResultSet<Movie_ResultSet>> UpdateMovie(Int64 Movie_id, String name, String director, String genre, String language, decimal price)
        {
            Generic_ResultSet<Movie_ResultSet> result = new Generic_ResultSet<Movie_ResultSet>();
            try
            {
