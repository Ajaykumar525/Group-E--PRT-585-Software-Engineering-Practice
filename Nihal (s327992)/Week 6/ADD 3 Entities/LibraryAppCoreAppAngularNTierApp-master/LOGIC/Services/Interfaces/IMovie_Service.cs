...
namespace LOGIC.Services.Interfaces
{
    public interface IMovie_Service
    {
        ...
        Task<Generic_ResultSet<Movie_ResultSet>> AddMovie(String name, String director, String genre, String language, decimal price);
        Task<Generic_ResultSet<Movie_ResultSet>> UpdateMovie(Int64 id, String name, String director, String genre, String language, decimal price);
